...
<body>
    <form id="form1" runat="server">
        ...
        <asp:TextBox ID="txtNum1" pattern ="[-+]?[0-9]*\.?[0-9]+" runat="server" Height="30px" placeholder ="Enter number only"></asp:TextBox> <br/>
        ...
        <asp:TextBox ID="txtNum2" pattern ="[-+]?[0-9]*\.?[0-9]+" runat="server" Height="30px" placeholder ="Enter number only"></asp:TextBox> <br/>
